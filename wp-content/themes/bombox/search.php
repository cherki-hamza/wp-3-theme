 ...
 * @since   1.0.0
 * @version 2.5.0
 * @var $template_helper Boombox_Search_Template_Helper Template Helper
 */
...
$template_helper = Boombox_Template::init( 'search' );
...
<div class="container main-container <?php echo boombox_get_container_classes_by_type( $template_options[ 'listing_type' ] ); ?>">
	...
	<?php do_action( 'boombox/before_template_content', 'search' ); ?>
	<div class="bb-row">
			...
			<div class="bb-row">
				<div class="bb-col col-site-main">
					<div class="site-main" role="main">
						...
						do_action( 'boombox/loop-start', 'search', array( 'listing_type' => $template_options[ 'listing_type' ] ) ); ?>
						<div class="bb-post-collection <?php echo boombox_get_list_type_classes( $template_options[ 'listing_type' ], array( 'col-2' ) ); ?>">
							...
							do_action( 'boombox/loop-end', 'search' );?>
						</div>
						<?php } else {
								boombox_get_template_part( 'template-parts/content', 'none' );
							}
							wp_reset_query();
							?>
	...
	<?php do_action( 'boombox/after_template_content', 'search' ); ?>
