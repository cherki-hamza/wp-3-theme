...
<div id="buddypress">
	...
	<div class="page" id="register-page">
		...
		<?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
			...
			/** This action is documented in bp-templates/bp-legacy/buddypress/activity/index.php */
			do_action( 'template_notices' ); ?>
			<h1><?php _e( 'Registering for this site is easy', 'boombox' ); ?></h1>
			<h3><?php _e( 'Just fill in the fields below, and we\'ll get a new account set up for you in no time.', 'boombox' ); ?></h3>
			...
			<div class="register-section" id="basic-details-section">
				...
				<div class="bb-form-block">
					...
					<div class="input-field"><input type="text" name="signup_username" id="signup_username" placeholder="<?php _e( 'Username', 'buddypress' ); ?> <?php _e( '*', 'buddypress' ); ?>" value="<?php bp_signup_username_value(); ?>" <?php bp_form_field_attributes( 'username' ); ?>/></div>
					...
					<div class="input-field"><input type="email" name="signup_email" id="signup_email" placeholder="<?php _e( 'Email Address', 'buddypress' ); ?> <?php _e( '*', 'buddypress' ); ?>" value="<?php bp_signup_email_value(); ?>" <?php bp_form_field_attributes( 'email' ); ?>/></div>
					...
					<div class="input-field"><input type="password" name="signup_password" id="signup_password" placeholder="<?php _e( 'Choose a Password', 'buddypress' ); ?> <?php _e( '*', 'buddypress' ); ?>" value="" class="password-entry" <?php bp_form_field_attributes( 'password' ); ?>/></div>
					...
					<div class="input-field"><input type="password" name="signup_password_confirm" id="signup_password_confirm" placeholder="<?php _e( 'Confirm Password', 'buddypress' ); ?> <?php _e( '*', 'buddypress' ); ?>" value="" class="password-entry-confirm" <?php bp_form_field_attributes( 'password' ); ?>/></div>
				...
				<div class="register-section" id="profile-details-section">
					...
					<div class="bb-form-block">
						...
						<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
							...
							<div<?php bp_field_css_class( 'editfield bbp-editfield input-field' ); ?> >
								...
								if ( bp_current_user_can( 'bp_xprofile_change_field_visibility' ) ) : ?>
									...
									<div class="field-visibility-settings" id="field-visibility-settings-<?php bp_the_profile_field_id() ?>">
										...
										<a class="field-visibility-settings-close bb-btn-close" href="#"><?php //_e( 'Close', 'buddypress' ) ?></a>
			...
			<div class="submit bb-form-row-actions">
				<div class="captcha-col">
					<?php do_action( 'bbp_captcha' ); ?>
				</div>

				<div class="btn-col">
					<div class="input-field"><input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" /></div>
				</div>
			</div>
