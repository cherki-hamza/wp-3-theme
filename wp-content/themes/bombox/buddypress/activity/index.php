...
<div id="buddypress">
	...
	<div class="bbp-main-nav item-list-tabs activity-type-tabs" role="navigation">
		<ul>
			<?php
	...
	<div class="item-list-tabs no-ajax" id="subnav" role="navigation">
		<ul>
			<li class="feed">
                <a href="<?php bp_sitewide_activity_feed_link(); ?>" title="<?php esc_attr_e( 'RSS Feed', 'buddypress' ); ?>"><?php _e( 'RSS', 'buddypress' ); ?></a>
            </li>
