		...
		<div class="item-body" id="group-create-body">
			...
			<?php if ( bp_is_group_creation_step( 'group-settings' ) ) : ?>
				...
				<div class="radio">
					...
					<label class="bbp-radio" for="group-status-public">
					...
					<label class="bbp-radio" for="group-status-private">
                        ...
                        <span class="bbp-radio-check"></span>
                        <?php _e( 'This is a private group', 'buddypress' ); ?></label>
					...
					<label class="bbp-radio" for="group-status-hidden">
                        ...
                        <span class="bbp-radio-check"></span>
                        <?php _e('This is a hidden group', 'buddypress' ); ?></label>
				...
				<div class="radio">
					...
					<label class="bbp-radio" for="group-invite-status-members">
                        ...
                        <span class="bbp-radio-check"></span>
                        <?php _e( 'All group members', 'buddypress' ); ?></label>

					<label class="bbp-radio" for="group-invite-status-mods">
					...
					<label class="bbp-radio" for="group-invite-status-admins">
				...
				<?php if ( bp_is_active( 'forums' ) ) : ?>
					...
					<?php if ( bp_forums_is_installed_correctly() ) : ?>
						...
						<div class="checkbox">
							<label class="bbp-checkbox" for="group-show-forum">
			...
			<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
				...
				<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
                    <div class="bbp-create-group-avatar">
                        <div class="left-menu">
				...
				<?php if ( bp_is_active( 'friends' ) && bp_get_total_friend_count( bp_loggedin_user_id() ) ) : ?>
                    ...
                    <div class="clearfix">
                        <div class="left-menu">
                            ...
                            <div id="invite-list">
                                <h4><?php _e( 'Add Users to Invite List', 'buddypress' ); ?></h4>
                                <ul>
