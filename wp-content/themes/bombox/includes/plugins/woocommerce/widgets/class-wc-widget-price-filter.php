 ...
 * @extends  WC_Widget
 */
class Boombox_WC_Widget_Price_Filter extends WC_Widget_Price_Filter {
			...
			<div class="price_slider_wrapper">
				...
				<div class="price_slider_amount">
					...
					<div class="price_label" style="display:none;">
						<span class="price-txt">' . __( 'Price', 'woocommerce' ) . '</span><span class="price-val"> <span class="from"></span> &mdash; <span class="to"></span></span>
					</div>
					' . $fields . '
					<div class="clear"></div>
				</div>
