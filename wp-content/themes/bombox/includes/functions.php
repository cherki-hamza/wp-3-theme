...
function boombox_get_post_reading_time( $args = array() ) {
	...
	$output = '<!--googleoff: index--><span class="' . esc_attr( $class ) . '"><span class="bb-clock bb-icon bb-ui-icon-clock"></span><span class="bb-text">' . $output . '</span></span><!--googleon: index-->';
