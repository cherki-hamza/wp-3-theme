<?php
/**
 * The template part for displaying featured area "1l" template
 *
...
if ( $template_query && $template_query->have_posts() ) {
	$boombox_area_elements = $template_helper->fill_template_absentee_items( $template_query->posts, 'type-1long' ); ?>
	<div class="container bb-featured-area item-1 boxed <?php echo $template_options['class']; ?>">
