<?php
/**
 * The template part for displaying featured area "1-2-1-stretched" template
 *
...
if ( $template_query && $template_query->have_posts() ) {
	$boombox_area_elements = $template_helper->fill_template_absentee_items( $template_query->posts, 'type-1-2-1-stretched' ); ?>
	<div class="container bb-featured-area stretched item-1-2-1-stretched <?php echo $template_options['class']; ?>">
