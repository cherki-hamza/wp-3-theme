...
$listing_type        = 'content-masonry-stretched';
...
if ( $show_media ) {
	...
	$media_wrapped     = boombox_do_post_thumbnail_wrap( $post_thumbnail_html, $url, $target, $rel );
    $media_html        = $media_wrapped['before'] . $post_thumbnail_html . $media_wrapped['after'];
	$is_media_playable = $media_wrapped['is_playable'];
} ?>
