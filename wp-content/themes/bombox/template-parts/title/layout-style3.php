<?php
/**
 * Template for displaying template header's "Style 3" template
 *
...
<header class="container bb-page-header style-center-wide <?php echo $template_options[ 'class' ][ 'primary' ]; ?>">
