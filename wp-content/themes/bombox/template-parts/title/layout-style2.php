<?php
/**
 * Template for displaying template header's "Style 2" template
 *
...
<header class="container bb-page-header style-center-narrow <?php echo $template_options[ 'class' ][ 'primary' ]; ?>">
