<?php
/**
 * The template part for displaying the site mobile navigation "Brand Center" template
 *
...
echo $template_options[ 'before' ]; ?>
	<header class="bb-header header-mobile h-style h-style-center large <?php echo $template_options[ 'class' ]; ?>">
