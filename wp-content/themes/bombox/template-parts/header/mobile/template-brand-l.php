<?php
/**
 * The template part for displaying the site mobile navigation "Brand Left" template
 *
...
echo $template_options[ 'before' ]; ?>
	<header class="bb-header header-mobile h-style h-style-left large <?php echo $template_options[ 'class' ]; ?>">
