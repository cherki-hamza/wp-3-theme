			...
			<div class="g1-column">
				...
				<div class="g1-mosaic g1-mosaic-4-4-4-4">
					<?php while ( $bimber_query->have_posts() ) : $bimber_query->the_post(); ?>
						<div class="g1-mosaic-item g1-mosaic-item-<?php echo absint( $bimber_query->current_post + 1 ); ?>">
							<?php get_template_part( 'template-parts/content-tile-l', get_post_format() ); ?>
						</div>
					<?php endwhile; ?>
				</div>
			</div>
