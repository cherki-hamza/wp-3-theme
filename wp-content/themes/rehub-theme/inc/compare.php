		...
		<div id="re-compare-bar" class="from-right">
			<div id="re-compare-bar-wrap">
				...
				<div id="re-compare-bar-tabs">
					...
					<?php endif; ?>
					<span class="re-compare-destin wpsm-button rehub_main_btn" data-compareurl=""><?php esc_html_e('Compare', 'rehub-theme');?><i class="rhicon rhi-arrow-circle-right" aria-hidden="true"></i></span>
				</div>
			</div>
		</div>
