...
if ( !defined( 'RH_MAIN_THEME_VERSION' ) ) {
	define('RH_MAIN_THEME_VERSION', '12.5');
}
...
$rehub_options = [
	'tf_username'      => 'smsc',
	'tf_purchase_code' => '2ca6daf9-1576-4cc7-9922-fb7fe4e427f7',
...
function rehub_framework_register_scripts() {
	...
	wp_register_script( 'justifygallery', get_template_directory_uri() . '/js/jquery.justifiedGallery.min.js', array('jquery'), '3.8.1', true );
